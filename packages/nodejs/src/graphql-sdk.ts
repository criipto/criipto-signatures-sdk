...
type BasicDocument_PdfDocument_Fragment = { __typename: 'PdfDocument', documentID: string, id: string, title: string, reference?: string | null, form?: { __typename?: 'PdfDocumentForm', enabled: boolean } | null };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    createSignatureOrder(variables: CreateSignatureOrderMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CreateSignatureOrderMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateSignatureOrderMutation>({ document: CreateSignatureOrderDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'createSignatureOrder', 'mutation', variables);
    },
    cleanupSignatureOrder(variables: CleanupSignatureOrderMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CleanupSignatureOrderMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CleanupSignatureOrderMutation>({ document: CleanupSignatureOrderDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'cleanupSignatureOrder', 'mutation', variables);
    },
    addSignatory(variables: AddSignatoryMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<AddSignatoryMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<AddSignatoryMutation>({ document: AddSignatoryDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'addSignatory', 'mutation', variables);
    },
    addSignatories(variables: AddSignatoriesMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<AddSignatoriesMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<AddSignatoriesMutation>({ document: AddSignatoriesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'addSignatories', 'mutation', variables);
    },
    changeSignatory(variables: ChangeSignatoryMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<ChangeSignatoryMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<ChangeSignatoryMutation>({ document: ChangeSignatoryDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'changeSignatory', 'mutation', variables);
    },
    closeSignatureOrder(variables: CloseSignatureOrderMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CloseSignatureOrderMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CloseSignatureOrderMutation>({ document: CloseSignatureOrderDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'closeSignatureOrder', 'mutation', variables);
    },
    cancelSignatureOrder(variables: CancelSignatureOrderMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CancelSignatureOrderMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CancelSignatureOrderMutation>({ document: CancelSignatureOrderDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'cancelSignatureOrder', 'mutation', variables);
    },
    signActingAs(variables: SignActingAsMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<SignActingAsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<SignActingAsMutation>({ document: SignActingAsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'signActingAs', 'mutation', variables);
    },
    validateDocument(variables: ValidateDocumentMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<ValidateDocumentMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<ValidateDocumentMutation>({ document: ValidateDocumentDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'validateDocument', 'mutation', variables);
    },
    extendSignatureOrder(variables: ExtendSignatureOrderMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<ExtendSignatureOrderMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<ExtendSignatureOrderMutation>({ document: ExtendSignatureOrderDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'extendSignatureOrder', 'mutation', variables);
    },
    deleteSignatory(variables: DeleteSignatoryMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<DeleteSignatoryMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteSignatoryMutation>({ document: DeleteSignatoryDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'deleteSignatory', 'mutation', variables);
    },
    createBatchSignatory(variables: CreateBatchSignatoryMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CreateBatchSignatoryMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateBatchSignatoryMutation>({ document: CreateBatchSignatoryDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'createBatchSignatory', 'mutation', variables);
    },
    changeSignatureOrder(variables: ChangeSignatureOrderMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<ChangeSignatureOrderMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<ChangeSignatureOrderMutation>({ document: ChangeSignatureOrderDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'changeSignatureOrder', 'mutation', variables);
    },
    signatureOrder(variables: SignatureOrderQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<SignatureOrderQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<SignatureOrderQuery>({ document: SignatureOrderDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'signatureOrder', 'query', variables);
    },
    signatureOrderWithDocuments(variables: SignatureOrderWithDocumentsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<SignatureOrderWithDocumentsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<SignatureOrderWithDocumentsQuery>({ document: SignatureOrderWithDocumentsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'signatureOrderWithDocuments', 'query', variables);
    },
    signatory(variables: SignatoryQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<SignatoryQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<SignatoryQuery>({ document: SignatoryDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'signatory', 'query', variables);
    },
    signatureOrders(variables: SignatureOrdersQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<SignatureOrdersQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<SignatureOrdersQuery>({ document: SignatureOrdersDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'signatureOrders', 'query', variables);
    },
    batchSignatory(variables: BatchSignatoryQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<BatchSignatoryQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<BatchSignatoryQuery>({ document: BatchSignatoryDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'batchSignatory', 'query', variables);
    }
  };
}
